...
import { scanRelationships, updateColumn } from "../api/datasets";
import type { RelationCandidate } from "../api/datasets";
        ...
        {scanMut.data && (
          <>
            ...
            <p style={{ margin: 0, fontSize: 11, color: "var(--color-text-muted)" }}>
              Score = 0.5 × (nombre coincide) + 0.5 × (proporción de valores que existen en la otra tabla).
              Las muestras se limitan a 200 registros por tabla.
            </p>
          </>
        )}
      </div>
