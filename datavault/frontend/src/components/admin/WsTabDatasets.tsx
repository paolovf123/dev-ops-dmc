      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }}>
          ...
          <input
            ...
            style={{ fontSize: 12, padding: "5px 9px", border: "1px solid var(--color-border)", borderRadius: 6, minWidth: 180 }}
          />
      ...
      {isLoading ? (
        ...
        <div style={{
          ...
          <p style={{ margin: 0, fontSize: 13 }}>
            {datasets.length === 0 ? "Sin datasets en este workspace todavía." : "Sin resultados para el filtro."}
          </p>
        </div>
      ) : (
...
function DatasetCard({ dataset, onClick }: { dataset: { id: string; name: string; description: string | null; is_bridge: boolean }; onClick: () => void }) {
  ...
  return (
    <div onClick={onClick}
      ...
      onMouseEnter={(e) => { e.currentTarget.style.borderColor = "var(--color-primary)"; e.currentTarget.style.boxShadow = "0 2px 8px rgba(0,154,68,0.10)"; }}
